...
########### For Supplemental Analysis
     ...
     MinAssaultSumPerc<-min(AssaultSumPerc,na.rm=T)
     ...
     MinAssaultSumCount<-min(AssaultSumCount,na.rm=T)
     ...
     MinWeaponsSumPerc<-min(WeaponsSumPerc,na.rm=T)
     ...
     MinWeaponsSumCount<-min(WeaponsSumCount,na.rm=T)
...
# First - Using rate+rate
     WhiteAssault <- AssaultSumPerc
     MaxWhiteAssault <- MaxAssaultSumPerc
     MinWhiteAssault <- MinAssaultSumPerc
     BlackAssault <- AssaultDifPerc
     MaxBlackAssault <- MaxAssaultDifPerc
     MinBlackAssault <- MinAssaultDifPerc

     WhiteWeapons <- WeaponsSumPerc
     MaxWhiteWeapons <- MaxWeaponsSumPerc
     MinWhiteWeapons <- MinWeaponsSumPerc
     BlackWeapons <- WeaponsDifPerc
     MaxBlackWeapons <- MaxWeaponsDifPerc
     MinBlackWeapons <- MinWeaponsDifPerc
